...
export default function GitPage() {
    ...
    // Filter active repos and separate pinned ones
    ...
    const RepoCard = ({ repo }: { repo: GitRepo }) => (
        ...
        >
            ...
            {repo.description && (
                <p style={{ color: "#a1a1aa", fontSize: "0.9rem", margin: 0, lineHeight: 1.5 }}>
                    {repo.description}
                </p>
            )}
        ...
        >
            ...
            >
                ...
                {unpinnedRepos.length > 0 && (
                    <div>
                        <motion.h2 variants={itemVariants} style={{ color: "#ffffff", fontSize: "1rem", fontWeight: 600, marginBottom: "1.5rem" }}>
                            All Repositories
                        </motion.h2>
                        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
